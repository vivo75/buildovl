...
if [[ ${PV} == *9999* ]] ; then
	...
	SRC_URI+=" test? ( https://gitlab.freedesktop.org/poppler/test/-/archive/${TEST_COMMIT}/test-${TEST_COMMIT}.tar.bz2 -> ${PN%-svg}-test-${TEST_COMMIT}.tar.bz2 )"
